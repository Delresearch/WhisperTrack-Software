...
// Add this to ensure the linker knows __io_putchar is used for printf
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOE, BUCK_10V_EN_Pin|BUCK_10V_MODE_Pin|BOOST_EN_Pin|GATE_DRIVE_EN_N_Pin
                          |OUTPUT_OD_N_Pin|SMPS_V1_Pin|SMPS_EN_Pin|SMPS_SW_Pin
                          |SAI1_EXTCLK_EN_N_Pin|BUCK_1V95_MODE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, VIN_DIV_EN_Pin|GPIO_PIN_14|BOOST_48V_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : BUCK_10V_EN_Pin BUCK_10V_MODE_Pin BOOST_EN_Pin GATE_DRIVE_EN_N_Pin
                           OUTPUT_OD_N_Pin SMPS_V1_Pin SMPS_EN_Pin SMPS_SW_Pin
                           SAI1_EXTCLK_EN_N_Pin BUCK_1V95_MODE_Pin */
  GPIO_InitStruct.Pin = BUCK_10V_EN_Pin|BUCK_10V_MODE_Pin|BOOST_EN_Pin|GATE_DRIVE_EN_N_Pin
                          |OUTPUT_OD_N_Pin|SMPS_V1_Pin|SMPS_EN_Pin|SMPS_SW_Pin
                          |SAI1_EXTCLK_EN_N_Pin|BUCK_1V95_MODE_Pin;
  ...
  GPIO_InitStruct.Pin = AMP_GS_Pin|VIN_DIV_EN_Pin|GPIO_PIN_14|BOOST_48V_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void EnableDebugFeatures(void) {
    ...
    // Optional: Enable fault handlers for UsageFault, BusFault, and MemManageFault
...
size_t osReceive(uint8_t *pData, uint16_t Size) {
    ...
    #endif
    // Start DMA transfer to fill the provided buffer
    HAL_SAI_Receive_DMA(&hsai_BlockA2, pData, Size);

    // Check how much data is available in the DMA buffer
    size_t availableData = Size - __HAL_DMA_GET_COUNTER(hsai_BlockA2.hdmarx);
